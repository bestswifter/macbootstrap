...
brew cask install qlcolorcode qlstephen qlmarkdown quicklook-json webpquicklook qlvideo provisionql quicklookapk
brew cask install --appdir='/usr/local/bin' qlimagesize # Avoid password
